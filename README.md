...
| Self-Forcing DMD warm-start              | provided in the EndlessWorld release                    | `checkpoints/self_forcing_dmd.pt` |
| EndlessWorld 3D-fusion checkpoint        | provided in the EndlessWorld release                    | `checkpoints/endlessworld.pt`     |
